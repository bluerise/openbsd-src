...
#define SMMU_V3_EVENTQ_BASE		0x0a0
#define  SMMU_V3_EVENTQ_BASE_WA			(1ULL << 62)
#define  SMMU_V3_EVENTQ_BASE_LOG2SIZE(x)	((uint64_t)(x) << 0)
#define SMMU_V3_EVENTQ_PROD		(0x0a8 + 0x10000)
#define SMMU_V3_EVENTQ_CONS		(0x0ac + 0x10000)
...
#define  SMMU_V3_CMD_TLBI_NH_VA_0_NUM(x)	(((uint64_t)(x) & 0x3f) << 12)
#define  SMMU_V3_CMD_TLBI_NH_VA_0_SCALE(x)	(((uint64_t)(x) & 0x7f) << 20)
#define  SMMU_V3_CMD_TLBI_NH_VA_0_VMID(x)	(((uint64_t)(x) & 0xffff) << 32)
#define  SMMU_V3_CMD_TLBI_NH_VA_0_ASID(x)	(((uint64_t)(x) & 0xffff) << 48)
#define  SMMU_V3_CMD_TLBI_NH_VA_1_LEAF		(1ULL << 0)
#define  SMMU_V3_CMD_TLBI_NH_VA_1_TTL(x)	(((uint64_t)(x) & 0x3) << 8)
#define  SMMU_V3_CMD_TLBI_NH_VA_1_TG(x)		(((uint64_t)(x) & 0x3) << 10)
