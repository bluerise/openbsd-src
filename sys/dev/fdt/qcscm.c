...
EFI_STATUS qcscm_uefi_get_variable(struct qcscm_softc *,
	    CHAR16 *, int, EFI_GUID *, uint32_t *,
	    uint8_t *, int *);
EFI_STATUS qcscm_uefi_set_variable(struct qcscm_softc *,
	    CHAR16 *, int, EFI_GUID *, uint32_t,
	    uint8_t *, int);
...
struct qcscm_dmamem *
		 qcscm_dmamem_alloc(struct qcscm_softc *, bus_size_t,
		    bus_size_t);
