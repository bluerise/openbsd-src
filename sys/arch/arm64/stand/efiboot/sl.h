...
EFI_STATUS sl_create_data(uint8_t *tcb_data, size_t tcb_size, struct sl_smc_params **smcdata, uint64_t *pe_data, uint64_t *pe_size, uint64_t *arg_data, uint64_t *arg_size);
